/*************************************************************\
|
|  RightJoin.cs started on 6/7 by Nicholas Fullerton
|
|  This class represents a RIGHT OUTER JOIN SQL operation
| 
\**************************************************************/
...
namespace SQuilL {
   class RightJoin {
     Table t1, t2, productTable, newTable;
      ...
      public RightJoin(Table table1, Table table2, List<string> keys) {
         t1 = table1; t2 = table2;
         key1 = keys[0];
         key2 = keys[1];
